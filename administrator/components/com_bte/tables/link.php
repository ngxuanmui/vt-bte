 ...
 * @since		1.5
 */
class BteTableLink extends JTable
{
	/**
	 * Constructor
	 *
	...
	function store($updateNulls = false)
	{
		...
		{
			// Get the old row
			$oldrow = JTable::getInstance('Banner', 'BteTable');
			...
			$table = JTable::getInstance('Banner', 'BteTable');
	...
	public function publish($pks = null, $state = 1, $userId = 0)
	{
		...
		$table = JTable::getInstance('Link', 'BteTable');
